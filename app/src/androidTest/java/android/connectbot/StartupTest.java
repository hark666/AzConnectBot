...
import com.autozone.android.connectbot.ConsoleActivity;
import com.autozone.android.connectbot.HostListActivity;
...
import static android.connectbot.ConnectbotMatchers.hasHolderItem;
import static android.connectbot.ConnectbotMatchers.withColoredText;
import static android.connectbot.ConnectbotMatchers.withConnectedHost;
import static android.connectbot.ConnectbotMatchers.withDisconnectedHost;
import static android.connectbot.ConnectbotMatchers.withHostNickname;
...
public class StartupTest {
	...
	public void localConnectionDisconnectFromHostList() {
		...
		onView(ViewMatchers.withId(R.id.console_flip)).perform(closeSoftKeyboard(), pressBack());
