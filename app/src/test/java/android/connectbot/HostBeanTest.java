...
import android.connectbot.mock.BeanAssertions;
...
public class HostBeanTest {
	...
	public void testBeanMeetsEqualsContract() {
		BeanAssertions.assertMeetsEqualsContract(HostBean.class, FIELDS);
	}

	@Test
	public void testBeanMeetsHashCodeContract() {
		BeanAssertions.assertMeetsHashCodeContract(HostBean.class, FIELDS);
	}
}
