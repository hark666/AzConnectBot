...
package com.autozone.android.connectbot.bean;

import com.autozone.android.connectbot.transport.Local;
...
public class HostBean extends AbstractBean {
	...
	public ContentValues getValues() {
		...
		values.put(HostDatabase.FIELD_HOST_APPNAME, appname);
		values.put(HostDatabase.FIELD_HOST_ENVIROMENT, enviroment);
	...
	public static HostBean fromContentValues(ContentValues values) {
		...
		host.setAppname(values.getAsString(HostDatabase.FIELD_HOST_APPNAME));
		host.setEnviroment(values.getAsString(HostDatabase.FIELD_HOST_ENVIROMENT));
	...
	public boolean equals(Object o) {
		...
		if (appname == null) {
			if (host.getAppname() != null)
				return false;
		} else if (!appname.equals(host.getAppname()))
			return false;

		if (enviroment == null) {
			if (host.getEnviroment() != null)
				return false;
		} else if (!enviroment.equals(host.getEnviroment()))
			return false;
