...
package com.autozone.android.connectbot.data;
...
public interface HostStorage {
	...
	List<String> getEnviroments(String appName);
	List<HostBean> getHosts(String appName, String enviroments, boolean sortedByColor);
